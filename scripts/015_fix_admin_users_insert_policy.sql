-- The original schema (000_create_admin_table.sql) only created SELECT policies for
-- admin_users, and 006_fix_rls_policies.sql added INSERT/UPDATE/DELETE policies for
